...
module.exports = function ToConfigure(app) {
  ...
  return function configure (){
    ...
    if (app.config.sockets.adapter === 'memory') {
      ...
      '   npm install @sailshq/socket.io-redis --save'+'\n'
      );
    }
    ...
    if (_.isUndefined(app.config.sockets.onlyAllowOrigins) && _.isUndefined(app.config.sockets.beforeConnect) && NODE_ENV==='production') {
      throw new Error(
                      '\n-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-\n'+
    ...
    if (_.isUndefined(app.config.sockets.beforeConnect) && _.isArray(app.config.sockets.onlyAllowOrigins)) {
      ...
      if (NODE_ENV==='production' && _.all(app.config.sockets.onlyAllowOrigins, function(origin) {
