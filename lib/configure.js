...
module.exports = function ToConfigure(app) {
  ...
  return function configure (){
    ...
    if (_.isUndefined(app.config.sockets.onlyAllowOrigins) && _.isUndefined(app.config.sockets.beforeConnect) && nodeEnv==='production') {
      throw new Error(
                      '\n-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-\n'+
    ...
    if (_.isUndefined(app.config.sockets.beforeConnect) && _.isArray(app.config.sockets.onlyAllowOrigins)) {
      ...
      if (nodeEnv==='production' && _.all(app.config.sockets.onlyAllowOrigins, function(origin) {
